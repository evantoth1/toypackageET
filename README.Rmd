...
The goal of `toypackageET` is to provide convenience functions for some common tasks.

## Installation

You can install the development version of `toypackageET` from [GitHub](https://github.com/) with:
